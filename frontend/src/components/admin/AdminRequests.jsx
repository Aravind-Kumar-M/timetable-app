        ...
        <div className="dashboard-fade-in">
            <div className="page-header" style={{ marginBottom: '2rem' }}>
                ...
                <p style={{ color: 'var(--text-muted)', marginTop: '0.5rem' }}>
                    Finalize slot change requests with automatic classroom assignment
                </p>
            </div>
                                ...
                                <div style={{ display: 'flex', gap: '1rem', marginTop: '1.5rem', paddingTop: '1.5rem', borderTop: '1px solid var(--border)' }}>
                                    <button
                                        ...
                                        style={{
                                            flex: 1,
                                            padding: '0.75rem',
                                            backgroundColor: processing === req._id ? '#9ca3af' : '#2563EB',
                                            color: '#FFFFFF',
                                            border: 'none',
                                            borderRadius: 'var(--radius-md)',
                                            fontSize: '1rem',
                                        ...
                                        onMouseEnter={(e) => processing !== req._id && (e.currentTarget.style.backgroundColor = '#1D4ED8')}
                                        onMouseLeave={(e) => processing !== req._id && (e.currentTarget.style.backgroundColor = '#2563EB')}
                                    >
                                        {processing === req._id ? (
